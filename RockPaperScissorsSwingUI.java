...
public class RockPaperScissorsSwingUI extends JFrame implements ActionListener {
	...
	private static final String[] emojis = {"✊", "✋", "✌️"}; // Rock, Paper, Scissors
	...
	private static void determineWinner(int userChoiceIndex, int computerChoiceIndex) {
		if (userChoiceIndex == computerChoiceIndex) resultLabel.setText("🏆 It's a Draw!");
		...
		else resultLabel.setText("👎 Computer Wins!");
		disableButtons();
	}
